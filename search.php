...
$pagination = "";
	...
	{	
		...
		//previous button
		if ($page > 1) 
			$pagination.= "<li class=\"prev\"><a href=\"$targetpage?keywords=$search&page=$prev\" class=\"prev\" rel=\"prev\"> Previous</a></li>";
		else
		...
		{	
			for ($counter = 1; $counter <= $lastpage; $counter++)
			{
				if ($counter == $page)
					...
					$pagination.= "<li><a href=\"$targetpage?keywords=$search&page=$counter\">$counter</a></li>";					
			}
		}
		elseif($lastpage > 5 + ($adjacents * 2))	//enough pages to hide some
		{
			...
			if($page < 1 + ($adjacents * 2))		
			{
				...
				$pagination.= "...";
				$pagination.= "<li><a href=\"$targetpage?keywords=$search&page=$lpm1\">$lpm1</a></li>";
				$pagination.= "<li><a href=\"$targetpage?keywords=$search&page=$lastpage\">$lastpage</a></li>";		
			}
			//in middle; hide some front and some back
			elseif($lastpage - ($adjacents * 2) > $page && $page > ($adjacents * 2))
			{
				$pagination.= "<li><a href=\"$targetpage?keywords=$search&page=1\">1</a></li>";
				$pagination.= "<li><a href=\"$targetpage?keywords=$search&page=2\">2</a></li>";
				$pagination.= "...";
		...
		//next button
		if ($page < $counter - 1) 
			$pagination.= "<li class=\"next\"><a href=\"$targetpage?keywords=$search&page=$next\" class=\"next\" rel=\"next\">Next </a></li>";
		else
			$pagination.= "<li class=\"next\"><a class=\"prev disabled\">Next</a></li>";
		$pagination.= "</ul>\n";		
	}
