<?php /* Smarty version 2.6.20, created on 2015-06-21 19:06:36
        ...
        <div id="profile-tabs">
            <div class="tabbable tabs-left">
              <ul class="nav nav-tabs">
				...
				<?php endif; ?>
                <li><a href="#pm-pro-playlists" id="pm-pro-playlists-btn" data-profile-id="<?php echo $this->_tpl_vars['profile_data']['id']; ?>
