...
<link rel="shortcut icon"  type="image/png" href="{$smarty.const._URL}/templates/{$template_dir}/favicon/favicon.png">
...
<div class="span12 header-ad" style="color:#FFF">
<!--
<a id="top"></a>
{if $ad_1 != ''}
...
<div class="span12 holder">
            <div class="span3">                {if $_custom_logo_url != ''}
            <a href="{$smarty.const._URL}/index.{$smarty.const._FEXT}" rel="home">
                <img src="{$_custom_logo_url}" alt="{$smarty.const._SITENAME}" title="{$smarty.const._SITENAME}" border="0" /></a>
      {else}
    <span class="site-title"><a href="{$smarty.const._URL}/index.{$smarty.const._FEXT}" rel="home" style="font-size:28px; color:#FFF">{$smarty.const._SITENAME}</a></span>
      {/if}</div>
              <div class="span9 nav-bar">
                  <div class="row">
                      <div class="span5">
                          <nav>
                          <ul id="nav">
                                <li><a href="{$smarty.const._URL}/submit_video.html">Submit Video</a></li>
                    ...
                    <div class="span5">
                        <form action="{$smarty.const._URL}/search.php" method="post" id="search"  class="search-form" name="search" onSubmit="return validateSearch('true');">
                        <fieldset>
