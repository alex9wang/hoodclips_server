		...
		<div id="primary">
			...
			<div class="modal hide" id="new-playlist" role="dialog" aria-labelledby="new-playlist-form-label">
				...
				<div class="modal-footer">
					...
					<a href="#" class="btn btn-link" data-dismiss="modal" >{$lang.submit_cancel}</a>
					<a href="#" class="btn btn-success" id="create_playlist_submit_btn" onclick="playlist_create(this, 'playlists-modal'); return false;" disabled>{$lang.submit_save}</a>
				</div>
			</div>
			</form>
			{/if}
