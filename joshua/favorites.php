 ...
 * 
 * Keeping old links working by redirecting the user to the new location
 */
...
$playlist = get_user_playlist_favorites($userdata['id']);
header('Location: '. $playlist['playlist_href']);	
exit();
// -----
