			...
			<tr class="<?php echo $col;?>" id="article-<?php echo $article['id'];?>">
			 ...
			 <td align="center" style="text-align:center" width="20">
			    <?php if ($article['restricted'] == '1') : ?>
					<div class="pm-sprite ico-locked" rel="tooltip" align="absbottom" title="Only registered users can read this article."></div>
				<?php endif; ?>
				<?php if ($article['status'] == 0) : ?>
					<a href="#" rel="tooltip" title="This is a private article (Draft). Only Administrators and Editors can see this article"><i class="icon-eye-close"></i></a>
				<?php endif; ?>
			 </td>
			 <td>
