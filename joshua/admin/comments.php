...
<div id="adminPrimary">
    ...
    <div class="btn-toolbar">
        ...
        <div class="btn-group">
		<button type="submit" name="Submit" value="Approve checked" class="btn btn-small btn-success btn-strong">Approve checked</button>
        </div>
        <div class="btn-group">
		<button type="submit" name="Submit" value="Delete checked" class="btn btn-small btn-danger btn-strong">Delete checked</button>
        </div>
    </div>
    </div><!-- #list-controls -->
