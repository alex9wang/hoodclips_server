...
if((!isset($_POST['acceptlicence']) || $_POST['acceptlicence'] != 1) && $mod->licence != 'none' && $mod->licence != ''){
	...
	<input type="submit" class="btn btn-success" value="Install mod" /></div><!-- .content -->
</div><!-- .primary -->';
...
if($out === true){
	echo '<div class="alert alert-success">The mod has been succesfully installed. Additional information: '.$msg.'<br /><a href="mm_plugins.php">Back to plugin manager</a></div>';
	echo '</div><!-- .content -->
</div><!-- .primary -->';
require_once('footer.php');
	exit();
