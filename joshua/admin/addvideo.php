...
<div class="container row-fluid" id="post-page">
    ...
    <div class="span3">
		...
		<h4>Thumbnail</h4>
            ...
            <?php else : ?>
            <a href="#" id="show-thumb" rel="tooltip" title="Click here to specify a custom thumbnail URL"><img src="<?php echo $video_details['yt_thumb']; ?>" id="must" style="display:block;min-width:120px;width:100%;min-height:80px; no-repeat center center;" /></a>
            <?php endif; ?>
            <div class="">
...
<div id="adminPrimary">
	...
	<?php if((isset($_POST['filename']) && $_POST['filename'] != '') || $_POST['source_id'] == 1) : ?>
	<h2>Upload Video</h2>	
	<?php else : ?>
...
{
echo pm_alert_warning('<strong>Before importing your first YouTube video...</strong> 
						<br /><br />
			...
			*/
			...
			switch($mode)
			{
				case 1: 	//	 Outsource (e.g. youtube); 
					...
					{
						$message = "<strong>This video site is not supported</strong>. For a full list of supported video sites, open and read the 'Help' section (Top Right of this page).";
					}
				break;
			...
			else
			{
				...
				else
				{
					...
					else
					{
						...
						{
							$video_details['yt_thumb'] = str_replace('https:', 'http:', $video_details['yt_thumb']);
				...
				if ($img === false)
				{
					echo pm_alert_error('An error occurred while downloading the thumbnail.');
				}
				...
				else	//	Everything is good. Now we can add the new video to the database
				{
					...
					if((isset($_POST['filename']) && $_POST['filename'] != '') || $video_details['source_id'] == 1)
					{
