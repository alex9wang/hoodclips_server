...
if ($_POST['submit'] != '' && $pm_temp_id)
{
	...
	if (count($errors) == 0)
	{
		...
		if ($inputs['yt_thumb'] != '' && $r['thumbnail'] != '' && $r['source_id'] == $sources['localhost']['source_id'])
		{
			...
			{
				$inputs['yt_thumb'] = str_replace('https:', 'http:', $inputs['yt_thumb']);
    ...
    <span class="autosave-message">&nbsp;</span>
	 ...
	 <div class="span3">
        ...
        <h4>Publish</h4>
			...
			<div class="control-group">
            <label class="control-label" for="">Allow comments: <span id="value-comments"><strong><?php echo ($r['allow_comments'] == '1') ? 'yes' : 'no';?></strong></span> <a href="#" id="show-comments">Edit</a></label>
            <div class="controls" id="show-opt-comments">
                <label class="checkbox inline"><input type="radio" name="allow_comments" id="allow_comments" value="1" <?php echo ($r['allow_comments'] == '1') ? 'checked="checked"' : '';?> /> Yes</label> 
                <label class="checkbox inline"><input type="radio" name="allow_comments" id="allow_comments" value="0" <?php echo ($r['allow_comments'] != '1') ? 'checked="checked"' : '';?> /> No</label>
            </div>
            </div>
