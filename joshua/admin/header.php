...
if ($showm == '2')
{
	...
	if (in_array($_POST['data_source'], array('youtube', 'dailymotion', 'vimeo')))
	{
...
$tab_settings = $tab_video_sitemap + $tab_regular_sitemap;
?>
<!DOCTYPE html>
<!--[if IE 7 | IE 8 | IE 9]>
...
<div class="dbupdate-bar"><strong>Important: <a href="db_update.php" class="btn btn-small btn-normal btn-strong" target="_blank">Click here</a> to finalize the update process now. Do not skip this last step.</strong></div>
<?php elseif (version_compare($official_version, $config['version']) == 1) : ?>
