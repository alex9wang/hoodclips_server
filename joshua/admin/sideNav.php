...
<div id="wrapper">
    ...
    if (is_moderator() || is_editor())
    {
        ...
        <a href="videos.php" class="pm-menu-parent"><div class="pm-sprite ico-videos-new"></div> <span>Videos</span></a><?php if($tab_video_total > 0) {?><span class="pm-menu-count"><?php echo pm_number_format($tab_video_total); ?></span><?php } ?>
        <ul class="pm-sub-menu">
            ...
            <li <?php echo ($submenu == 'import') ? 'class="active"' : ''; ?>><a href="import.php">Import from Youtube</a></li>
            <li <?php echo ($submenu == 'import_user') ? 'class="active"' : ''; ?>><a href="import_user.php">Import from Youtube User</a></li>
            <li <?php echo ($submenu == 'reports') ? 'class="active"' : ''; ?>><a href="reports.php">Reported Videos</a><?php if($crps > 0) {?><span class="pm-submenu-count"><?php echo pm_number_format($crps); ?></span><?php } ?></li>
            <li <?php echo ($submenu == 'approve') ? 'class="active"' : ''; ?>><a href="approve.php">Approve Videos</a><?php if($vapprv > 0) {?><span class="pm-submenu-count"><?php echo pm_number_format($vapprv); ?></span><?php } ?></li>
        ...
        <a href="comments.php" class="pm-menu-parent"><div class="pm-sprite ico-comments-new"></div> <span>Comments</span></a><?php if($tab_comments > 0) {?><span class="pm-menu-count"><?php echo pm_number_format($tab_comments); ?></span><?php } ?>
        <ul class="pm-sub-menu">
		...
		<?php } ?>
        <li <?php echo ($submenu == 'comments-flagged') ? 'class="active"' : ''; ?>><a href="comments.php?filter=flagged">Flagged Comments</a><?php if($flagged_comments > 0) {?><span class="pm-submenu-count"><?php echo pm_number_format($flagged_comments); ?></span><?php } ?></li>
        <li <?php echo ($submenu == 'comments-pending') ? 'class="active"' : ''; ?>><a href="comments.php?filter=pending">Pending Comments</a><?php if($pending_comments > 0) {?><span class="pm-submenu-count"><?php echo pm_number_format($pending_comments); ?></span><?php } ?></li>
    ...
    ?>
        ...
        <ul class="pm-sub-menu">
        <li <?php echo ($submenu == 'ad_manager') ? 'class="active"' : ''; ?>><a href="ad_manager.php">Classic Ads</a></li>
        ...
        <a href="statistics.php" class="pm-menu-parent"><div class="pm-sprite ico-stats-new"></div> <span>Statistics &amp; Logs</span></a><?php if($tab_internallog > 0) {?><span class="pm-menu-count"><?php echo pm_number_format($tab_internallog); ?></span><?php } ?>
        <ul class="pm-sub-menu">
        <li <?php echo ($submenu == 'show_searches') ? 'class="active"' : ''; ?>><a href="show_searches.php">Search Log</a></li>
        <li <?php echo ($submenu == 'readlog') ? 'class="active"' : ''; ?>><a href="readlog.php">System Log</a><?php if($tab_internallog > 0) {?><span class="pm-submenu-count"><?php echo pm_number_format($tab_internallog); ?></span><?php } ?></li>
        ...
        <li <?php echo ($submenu == 'db_backup') ? 'class="active"' : ''; ?>><a href="<?php echo csrfguard_url(_URL .'/'. _ADMIN_FOLDER .'/db_backup.php?restart=1', '_admin_backupdb');?>" rel="tooltip" data-placement="right" title="An *.SQL file will be generated after clicking this link.">Backup Database</a></li>
