            ...
            <div class="tabbable tabs-left">
              <ul class="nav nav-tabs">
                {if $smarty.const._MOD_SOCIAL}
					<li {if  $s_user_id != $profile_data.id}class="active"{/if}><a href="#pm-pro-about" data-toggle="tab">{$lang.about_me}</a></li>
				...
				{/if}
                <li><a href="#pm-pro-playlists" id="pm-pro-playlists-btn" data-profile-id="{$profile_data.id}" data-toggle="tab">{$lang._playlists}</a></li>
