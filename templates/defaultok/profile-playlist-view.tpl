      ...
      <div class="row-fluid">
					...
					<div class="pm-pl-header row-fluid">
						...
						<div class="pm-pl-header-content span9">
							...
							<ul class="pm-pl-header-details unstyled">
								<li>{$lang._by} <a href="{$smarty.const._URL}/profile.{$smarty.const._FEXT}?u={$playlist.user_username}">{$playlist.user_name}</a></li>
							...
							<div class="pm-pl-actions">
								...
								{/if} 
								{if $my_playlist && $playlist.type != $smarty.const.PLAYLIST_TYPE_WATCH_LATER}
		...
		<div class="modal hide" id="playlist-share" role="dialog" aria-labelledby="playlist-share-form-label">
		    ...
		    <div class="modal-body">
                ...
                <div class="row-fluid">
                    <div class="span3">
	                    <a href="http://www.facebook.com/sharer.php?u={$share_link_urlencoded}&t={$share_title_urlencoded}" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" rel="tooltip" title="Share on FaceBook"><i class="pm-vc-sprite facebook-icon"></i></a>
	                    <a href="http://twitter.com/home?status=Watching%20{$share_title_urlencoded}%20on%20{$share_link_urlencoded}" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" rel="tooltip" title="Share on Twitter"><i class="pm-vc-sprite twitter-icon"></i></a>
		...
		{if $playlist.type != $smarty.const.PLAYLIST_TYPE_WATCH_LATER}
