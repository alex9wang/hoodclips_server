                    ...
                    <section class="box">
                                ...
                                <div>
                                       <span class="pm-video-attr-numbers">
                                           ...
                                           <!--
                                           <small>{$video_data.views_compact} {$lang.views} / {$video_data.comments_compact} {$lang.comments}</small>
                                       -->
                                           </span>
                                </div>
...
<section>
                <header class="heading">
                    <div class="span12">
                        <div class="offset2 span8">
                            <h1>
                                <time datetime="{$added_date2}">{$added_date2}</mark></time>
                            </h1>
                        </div>
                        <div class="span2">
...
{if $added_date4 !=""}
                ...
                <header class="heading">
                    <div class="span12">
                        <div class="offset2 span8">
                           <h1><time datetime="{$added_date4}">{$added_date4}</mark></time></h1></div>
                        <div class="span2">
