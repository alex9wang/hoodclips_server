...
//		$info['description'] = utf8_encode(html_entity_decode($info['description']));
		$info['video_title'] = html_entity_decode($info['video_title'], ENT_QUOTES, 'UTF-8');
		$info['description'] = html_entity_decode($info['description'], ENT_QUOTES, 'UTF-8');
		$info['description'] = str_replace('<br />', '', $info['description']);
