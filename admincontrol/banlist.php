...
<a href="#" class="btn-mini" data-dismiss="modal" aria-hidden="true">Cancel</a>
<button type="submit" name="Submit" value="Ban" class="btn btn-small btn-danger btn-strong" />Ban user</button>
