...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
	...
	<table cellpadding="0" cellspacing="0" width="100%" class="table table-striped table-bordered pm-tables pm-tables-settings">
      ...
      <tr>
          <td width="20%" valign="top">RTL Support</td>
          <td>
			...
			<a href="#" rel="popover" data-placement="right" data-trigger="hover" data-content="Useful for right-to-left layout/languages. May work only with select themes."><i class="icon-info-sign"></i></a>
          </td>
      </tr>
	  <?php endif; ?>
	...
	<table cellpadding="0" cellspacing="0" width="100%" class="table table-striped table-bordered pm-tables pm-tables-settings">
	  ...
	  <tr>
        ...
        <tr>
          <td width="20%" valign="top">Footer Image (Logo)</td>
          <td>
         
            <input type="file" name="custom_footer_logo_url"/>
            <img src="../uploads/<?php echo $config['custom_footer_logo_url'];?>" width="100" height="100"/>
	...
	{
	?>
    <div class="alert alert-danger">Sorry, the <strong><?php echo ucfirst($config['template_f']); ?></strong> theme doesn't support any customizations.</div>
    <?php
	} else {
	?>
