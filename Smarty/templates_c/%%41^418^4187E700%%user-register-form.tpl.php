<?php /* Smarty version 2.6.20, created on 2015-09-01 18:57:33
...
/include/securimage_show.php?sid=' + Math.random(); return false">
    ...
    <div class="control-group">
      ...
      <input type="checkbox" class="checkbox" id="agree" name="agree" <?php if ($this->_tpl_vars['inputs']['agree'] == 'on'): ?>checked="checked"<?php endif; ?>> <span class="help-inline">I agree with <a data-toggle="modal" href="#terms" id="element" >terms of agreement</a></span>
      </label>
      </div>
    </div>
