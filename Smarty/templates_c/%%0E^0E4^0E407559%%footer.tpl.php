<?php /* Smarty version 2.6.20, created on 2016-07-29 04:37:57
         compiled from footer.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'footer.tpl', 104, false),)), $this); ?>
...
<div class="text-center">
	<div class="row social-bar">
		...
		<img class="col-lg-2 col-md-2 col-sm-2 col-xs-10" src="<?php echo @_URL; ?>
/templates/<?php echo $this->_tpl_vars['template_dir']; ?>
/img/ic_white_logo.png" style="width:55px">
		<!--<div class="visible-lg visible-md col-lg-2 col-md-2"></div>-->
		<div class="visible-lg visible-md col-lg-7 col-md-7 col-lg-offset-3 col-md-offset-3">
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="width:220px">
			   	 <a href="https://www.facebook.com/TheHoodClips" target="_blank" class="btn btn-block btn-social btn-facebook">
					<span class="fa fa-facebook"></span> Follow Us On Facebook
				 </a>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="width:220px">
		   	 	<a href="https://twitter.com/thehoodclips" target="_blank" class="btn btn-block btn-social btn-twitter">
					<span class="fa fa-twitter"></span> Follow Us On Twitter
			 	</a>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="width:220px;">
			   	 <a href="http://instagram.com/hoodclips/" target="_blank" class="btn btn-block btn-social btn-instagram">
					<span class="fa fa-instagram"></span> Follow Us On Instagram
				 </a>
			</div> 
        </div>
        <div class="visible-sm visible-xs col-lg-10 col-md-10 col-sm-10 col-xs-10" >
        	<div class="col-lg-4 col-md-4 col-sm-3 col-xs-3">
			   	 <a href="https://www.facebook.com/TheHoodClips" target="_blank" class="btn btn-social-icon btn-facebook">
					<span class="fa fa-facebook"></span>
				 </a>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-3 col-xs-3">
		   	 	<a href="https://twitter.com/thehoodclips" target="_blank" class="btn btn-social-icon btn-twitter">
					<span class="fa fa-twitter"></span>
			 	</a>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-3 col-xs-3">
			   	 <a href="http://instagram.com/hoodclips/" target="_blank" class="btn btn-social-icon btn-instagram">
					<span class="fa fa-instagram"></span>
				 </a>
			</div> 
        </div>
	  	<!--<span class="social">
	 		<fb:like href="https://facebook.com/TheHoodClips" layout="button_count" show_faces="false" width="240" height="30" action="like" colorscheme="light"></fb:like> 
		</span>
	 	<span class="social">
	  		<a href="https://twitter.com/thehoodclips" class="twitter-follow-button" data-show-count="false" data-show-screen-name="false" data-size="large">Follow @thehoodclips</a>
		</span>
...
.ig-b-v-24 { width: 137px; height: 30px; background: url(//badges.instagram.com/static/images/ig-badge-view-sprite-24.png) no-repeat 0 0; }
@media only screen and (-webkit-min-device-pixel-ratio: 2), only screen and (min--moz-device-pixel-ratio: 2), only screen and (-o-min-device-pixel-ratio: 2 / 1), only screen and (min-device-pixel-ratio: 2), only screen and (min-resolution: 192dpi), only screen and (min-resolution: 2dppx) {
.ig-b-v-24 { background-image: url(//badges.instagram.com/static/images/ig-badge-view-sprite-24@2x.png); background-size: 160px 178px; } }</style>
'; ?>

	<a href="http://instagram.com/hoodclips?ref=badge" target="_blank" class="ig-b- ig-b-v-24"><img src="//badges.instagram.com/static/images/ig-badge-view-24.png"  alt="Instagram" /></a>-->
	</div>
...
<!-- 
<a class="btn btn-social-icon btn-facebook" href="https://www.facebook.com/TheHoodClips" target="_blank" onclick="_gaq.push(['_trackEvent', 'btn-social-icon', 'click', 'btn-facebook']);"><i class="fa fa-facebook"></i></a>

<a class="btn btn-social-icon btn-twitter" href="https://twitter.com/thehoodclips" target="_blank" onclick="_gaq.push(['_trackEvent', 'btn-social-icon', 'click', 'btn-twitter']);"><i class="fa fa-twitter"></i></a>

<a href="http://instagram.com/hoodclips/" target="_blank" class="btn btn-social-icon btn-instagram" onclick="_gaq.push(['_trackEvent', 'btn-social-icon', 'click', 'btn-instagram']);"><i class="fa fa-instagram"></i></a>
</div>
-->   
...
">
    <i class="fa fa-arrow-up icon-chevron-up"></i>
    <span></span>
</a>
<footer>
...
"><?php echo $this->_tpl_vars['lang']['title']; ?>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 footer-logo">
        ...
        <p style="text-align:center;margin-top:20px;">
            <img class="img-responsive" src="/uploads/1426436315_HOODCLIPS2.png" alt="">
        </p>
