...
INSERT INTO `pm_categories` (`id`, `parent_id`, `tag`, `name`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`) VALUES(1, 0, 'categoryone', 'Sample Category #1', 2, 2, 1, '', '');
INSERT INTO `pm_categories` (`id`, `parent_id`, `tag`, `name`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`) VALUES(2, 1, 'subcat', 'Sample Sub-cat', 0, 0, 1, '', '');
INSERT INTO `pm_categories` (`id`, `parent_id`, `tag`, `name`, `published_videos`, `total_videos`, `position`, `description`, `meta_tags`) VALUES(3, 0, 'categorytwo', 'Sample Category #2', 1, 1, 2, '', '');
...
INSERT INTO `pm_config` (`name`, `value`) VALUES('version', '2.3.1');
...
INSERT INTO `pm_config` (`name`, `value`) VALUES('dailymotion_syndication_key', '');
...
INSERT INTO `pm_sources` (`source_id`, `source_name`, `source_rule`, `url_example`, `last_check`, `flv_player_support`, `embed_player_support`, `embed_code`, `user_choice`) VALUES(5, 'dailymotion', '/dailymotion\\./i', 'http://www.dailymotion.com/en/category/[VIDEO ID]_video-title-here', 0, '0', '1', '<object width="%%player_w%%" height="%%player_h%%">\r\n <param name="movie" value="http://www.dailymotion.com/swf/%%yt_id%%&related=0&autoplay=%%player_autoplay%%&logo=0&info=0&hideInfos=1&%%player_extra_params%%"></param>\r\n <param name="wmode" value="%%player_wmode%%"></param>\r\n <param name="allowFullScreen" value="true"></param><param name="allowScriptAccess" value="always"></param>\r\n <embed src="http://www.dailymotion.com/swf/%%yt_id%%&related=0&autoplay=%%player_autoplay%%&logo=0&info=0&hideInfos=1&%%player_extra_params%%" type="application/x-shockwave-flash" width="%%player_w%%" height="%%player_h%%" allowFullScreen="true" wmode="%%player_wmode%%" allowScriptAccess="always"></embed>\r\n</object>', 'embed');
...
INSERT INTO `pm_sources` (`source_id`, `source_name`, `source_rule`, `url_example`, `last_check`, `flv_player_support`, `embed_player_support`, `embed_code`, `user_choice`) VALUES(30, 'liveleak', '/liveleak\\.com/i', 'http://www.liveleak.com/view?i=[VIDEO ID]', 0, '0', '1', '<iframe width="%%player_w%%" height="%%player_h%%" src="//www.liveleak.com/ll_embed?f=%%yt_id%%" frameborder="0" allowfullscreen></iframe>', 'embed');
...
INSERT INTO `pm_sources` (`source_id`, `source_name`, `source_rule`, `url_example`, `last_check`, `flv_player_support`, `embed_player_support`, `embed_code`, `user_choice`) VALUES(53, 'vbox7', '/vbox7\\.com\\/play/i', 'http://vbox7.com/play:[VIDEO ID]', 0, '1', '1', '<iframe width="%%player_w%%" height="%%player_h%%" src="http://vbox7.com/emb/external.php?vid=%%yt_id%%" frameborder="0" allowfullscreen></iframe>', 'flvplayer');
INSERT INTO `pm_sources` (`source_id`, `source_name`, `source_rule`, `url_example`, `last_check`, `flv_player_support`, `embed_player_support`, `embed_code`, `user_choice`) VALUES(77, 'cloudy.ec', '/cloudy\\.ec/i', 'http://www.cloudy.ec/v/[VIDEO ID]', 0, '0', '1', '<iframe width="%%player_w%%" height="%%player_h%%" src="//www.cloudy.ec/embed.php?id=%%yt_id%%" frameborder="0" border="0" marginwidth="0" marginheight="0" scrolling="no" allowfullscreen></iframe>', 'embed');
...
INSERT INTO `pm_sources` (`source_id`, `source_name`, `source_rule`, `url_example`, `last_check`, `flv_player_support`, `embed_player_support`, `embed_code`, `user_choice`) VALUES(78, 'myvideo.ge', '/myvideo\\.ge/i', 'http://www.myvideo.ge/?video_id=[VIDEO ID]', 0, '0', '1', '<iframe width="%%player_w%%" height="%%player_h%%" src="//embed.myvideo.ge/flv_player/player.php?video_id=%%yt_id%%" frameborder="0" border="0" marginwidth="0" marginheight="0" scrolling="no" allowfullscreen></iframe>', 'embed');
INSERT INTO `pm_sources` (`source_id`, `source_name`, `source_rule`, `url_example`, `last_check`, `flv_player_support`, `embed_player_support`, `embed_code`, `user_choice`) VALUES(79, 'vevo', '/vevo\\.com/i', 'http://www.vevo.com/watch/[VIDEO ID]', 0, '0', '1', '<iframe width="%%player_w%%" height="%%player_h%%" src="//cache.vevo.com/assets/html/embed.html?video=%%yt_id%%&autoplay=0" frameborder="0" border="0" marginwidth="0" marginheight="0" scrolling="no" allowfullscreen></iframe>', 'embed');
INSERT INTO `pm_sources` (`source_id`, `source_name`, `source_rule`, `url_example`, `last_check`, `flv_player_support`, `embed_player_support`, `embed_code`, `user_choice`) VALUES(80, 'facebook', '/facebook.com/i', 'https://www.facebook.com/video.php?v=video-id', 0, '0', '1', '<iframe src="//www.facebook.com/video/embed?video_id=%%yt_id%%" width="%%player_w%%" height="%%player_h%%" frameborder="0"></iframe>', 'embed');
